...
| kreuzberg  | Yes       | Yes       | Yes       | Yes       | No        | No        | No        |
...
| pdo_sqlsrv | >=5.13.0  | >=5.12.0  | Yes       | >=5.11.0  | Yes       | Yes       | <5.11     |
| phalcon    | >=5.11.0  | Yes       | Yes       | Yes       | Yes       | Yes       | Yes       |
| protobuf   | Yes       | Yes       | Yes       | Yes       | Yes       | Yes       | >=3.21.12 |
| raphf      | Yes       | Yes       | Yes       | Yes       | Yes       | Yes       | Yes       |
| redis      | >=6.3.0   | Yes       | Yes       | Yes       | Yes       | >=5.3.0   | >=5.0.2   |
| sqlsrv     | >=5.13.0  | >=5.12.0  | Yes       | >=5.11.0  | >=5.10.0  | >=5.9.0   | Yes       |
| ssh2       | Yes       | Yes       | Yes       | Yes       | Yes       | Yes       | Yes       |
| swoole     | >=6.2.0   | >=6.0.0   | Yes       | Yes       | Yes       | Yes       | Yes       |
| uuid       | Yes       | Yes       | Yes       | Yes       | Yes       | >=1.2.0   | Yes       |
| xdebug     | Yes       | >=3.4.0   | >=3.3.0   | >=3.2.0   | >=3.1.0   | >=3.0.0   | Yes       |
