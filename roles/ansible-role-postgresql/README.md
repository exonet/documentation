...
| `postgresql_version`                     | `18.3`                                                                  | The version of PostgreSQL to install.                               |
| `postgresql_pg_hba_local_auth_method`    | `peer`                                                                  | Set `method` for local authentication in pg_hba config.             |
